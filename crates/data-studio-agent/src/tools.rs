// ---------------------------------------------------------------------------
// Tool-definition helpers — read from the global capability registry and
// produce OpenAI-format tool definitions for the LLM.
// ---------------------------------------------------------------------------
...
/// - `tools` — the array of OpenAI function‑calling tool definitions.
/// - `metadata` — a map from tool name to `{ riskLevel, requiredPermission }`.
...
/// Returns `None` when the tool has no required parameters or does not exist.
